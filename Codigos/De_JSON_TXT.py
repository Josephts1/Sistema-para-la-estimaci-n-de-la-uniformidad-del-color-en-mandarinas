...
input_path = "/content/drive/MyDrive/Proyecto_de_grado/data/labels/val"
output_path = "/content/drive/MyDrive/Proyecto_de_grado/data/labels/val/"
...
for file in files:
    ...
    with open(file, "r") as f:
        ...
        with open(f"{output_path}{name}.txt", 'w') as t:
